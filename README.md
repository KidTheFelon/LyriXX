...
**Ваш личный блокнот для личных песен.** Чистый, вдохновляющий и всегда под рукой.

---

## Что это?

LyriXX — десктопное приложение, созданное специально для сонграйтеров, авторов песен и музыкантов. Никакого отвлечения: только вы, ваши текста и музыка.

Упорядочивайте песни и заготовки, быстро находите нужное, редактируйте — и всё сохранится само.
...
- **Теги секций.** Помечайте части текста тегами: `[Куплет]`, `[Припев]`, `[Бридж]`, `[Интро]` и т.д. — они подсвечиваются цветом и парсятся из текста. 14 встроенных тегов + можно придумать свои.
- **Навигатор секций.** Боковая панель с секциями: клик — прыжок к месту, drag-and-drop — их перетаскивание.
- **Подсказки рифм.** Выделите слово — приложение покажет рифмы из словаря Зализняка или CMU. Попап появляется прямо в редакторе. Язык рифм: русский или английский или можно оставить автоматическим для более расширенного мыслей.
- **Категории.** «Песни» для готового, «Заготовки» для идей — создайте любую удобную для вас категорию (для личных можно даже значок изменить).
- **Поиск.** Мгновенный поиск по названию или исполнителю среди всех записей, чтобы ни одна ваша идея не забылась.
- **Автосохранение.** Ни одна строчка не потеряется — всё сохраняется автоматически с настраиваемой задержкой.
...
- **Смена темы.** Тёмная, светлая или как у системы. Работайте с комфортом для своих глаз.
- **Акцентный цвет.** 12 пресетов акцентных цветов для персонализации интерфейса + акцентная кастомизация под свой вкус.
- **Подсчёт слогов.** Автоматический подсчёт слогов в русских и английских словах (при условии что включен счетчик слов в настройках).
...
- **Музыкальные цитаты.** 108 случайных цитат на экране загрузки. Начинайте работу с подходящим настроем!
- **Локальное хранение.** Всё хранится прямо на вашем компьютере.
