...
Проект создан с существенным использованием ИИ. Весь код просматривался, тестировался и дорабатывался вручную. Подробнее — в [руководстве для разработчиков](docs/CONTRIBUTING.md).
