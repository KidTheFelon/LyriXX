...
Этот проект полностью создан с помощью ИИ (vibe coding). Автор не имеет опыта программирования — весь код, архитектурные решения и документация сгенерированы ИИ без ручного код-ревью. Использовались: Kilo (Claude).
