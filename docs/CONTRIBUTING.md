...
Этот проект создан с существенным использованием ИИ (Kilo / Claude). Все код, архитектурные решения и документация прошли ручную проверку, тестирование и доработку. ИИ использовался как инструмент ускорения разработки, а не как замена разработчику.
