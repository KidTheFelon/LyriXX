...
/** SVG-иконка редактирования (карандаш). */
...
/** SVG-иконка звезды (с возможностью заливки). */
...
/** SVG-иконка крестика (закрытие). */
export function IconClose({ size = 10 }: IconProps) {
  return (
...
/** SVG-иконка окна. */
export function IconWindow({ size = 14 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
